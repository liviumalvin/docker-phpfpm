...
RUN apt-get install -y wget nano curl make php5-dev php5-mysql php5-curl php5-gd php5-imap php5-tidy php5-json php5-mcrypt php5-redis php5-mongo php5-mysql php5-ldap
